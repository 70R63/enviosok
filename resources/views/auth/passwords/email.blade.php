								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<div class="clearfix"></div>
											<h5 class="text-left mb-2">Contraseña olvidada</h5>
											<p class="mb-4 text-muted tx-13 ml-0 text-left">No te preocupes, solo tomará unos minutos.</p>
											@if (session('status'))
											...
											<form method="POST" action="{{ route('password.email') }}">
												...
												<button  type="submit"  class="btn ripple btn-main-primary btn-block">Enviar vínculo</button>
											</form>
