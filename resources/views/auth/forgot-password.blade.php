            ...
            <div class="row row-sm">
                <div class="col-lg-6 col-xl-5 d-none d-flex align-items-center text-center bg-primary details">
                    <div class="mt-2 p-2 pos-absolute">
                        ...
                        <h5 class="mt-4 text-white">Recuperar contraseña</h5>
                        <span class="tx-white-6 tx-13 mb-5 mt-xl-0">Escribe tu correo electrónico para enviarte un enlace para restablecer tu contraseña.</span>
                    </div>
                </div>
