...
<div class="row row-sm">
    ...
    <div class="col-md-12 col-xl-12 col-lg-12 col-xxl-6">
        <div class="card custom-card">
            <div class="card-header border-bottom-0">
                <label class="main-content-label my-auto pt-2 tx-15-f">Cotiza tu Guia</label>
                <span class="d-block tx-12 mb-0 mt-1 text-muted">En esta session se busca usar para cotizar  .</span>
            </div>
