            ...
            <div class="d-flex mt-4">
                ...
                <div class="">
                    ...
                    <div class="d-flex my-auto">
                        <h4 class="mt-1 mb-0"> <span id="dashboardCreadas" ></span>
                        </h4>
                    </div>
                </div>
            </div>  
        ...
        <div class="card-body text-center">
           <div class="d-flex mt-4">
                ...
                <div class="">
                    ...
                    <div class="d-flex my-auto">
                        <h4 class="mt-1 mb-0"><span id="dashboardTransito" ></span>
                        </h4>
                    </div>
                </div>
            </div> 
        ...
        <div class="card-body text-center">
           <div class="d-flex mt-4">
                ...
                <div class="">
                    ...
                    <div class="d-flex my-auto">
                        <h4 class="mt-1 mb-0"><span id="dashboardEntregadas" ></span>
                        </h4>
                    </div>
                </div>
            </div> 
        ...
        <div class="card-body text-center">
            <div class="d-flex mt-4">
                ...
                <div class="">
                    ...
                    <div class="d-flex my-auto">
                        <h4 class="mt-1 mb-0"><span id="dashboardPromedio" ></span>
                        </h4>
                    </div>
                </div>
            </div> 
    ...
    <div class="card custom-card">
        <div class="card-body text-center">
            <div class="d-flex mt-4">
                ...
                <div class="">
                    <span class="main-content-label text-uppercase tx-14 mt-4 ">Saldo Actual</span>
                    <div class="d-flex my-auto">
                        <h4 class="mt-1 mb-0"><span id="dashboardActual" ></span>
                        </h4>
                    </div>
                </div>
            </div> 
